...
export class IDEAListELementsComponent {
   ...
   */
  public workingData: Array<IdeaX.Label | string>;
  /**
   * The list filtered by the current search terms.
   */
  public filteredList: Array<IdeaX.Label | string>;
  /**
  ...
  public ngOnInit() {
    ...
    this.workingData = Array.from(this.data || (this.labelElements ? new Array<IdeaX.Label>() : new Array<string>()));
  ...
  public addElement() {
    if (this.labelElements) {
      const l = new IdeaX.Label(null, this.t.languages());
   ...
   */
  public editElement(element: IdeaX.Label | string) {
    if (this.labelElements) this.editLabel(element as IdeaX.Label);
  }
  /**
   * Remove the selected element from the list.
   */
  public removeElement(element: IdeaX.Label | string) {
