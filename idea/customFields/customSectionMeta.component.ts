...
export class IDEACustomSectionMetaComponent {
   ...
   */
  public _section: IdeaX.CustomSectionMeta;
  /**
  ...
  public editName() {
    ...
    if (!this._section.name) {
      this._section.name = new IdeaX.Label(null, this.t.languages());
  ...
  public editDescription() {
    ...
    if (!this._section.description) {
      this._section.description = new IdeaX.Label(null, this.t.languages());
    ...
    const buttons = [
      { text: this.t._('COMMON.CANCEL'), role: 'cancel' },
      {
        ...
        handler: (data: any) => {
          ...
          const field = new IdeaX.CustomFieldMeta(null, this.t.languages());
          // initialize the name of the field
          field.name = new IdeaX.Label(null, this.t.languages());
      ...
      .create({
        ...
        componentProps: {
          data: this._section.fieldsLegend.map(
            x => new IdeaX.Suggestion({ value: x, name: this.getLabelValue(this._section.fields[x].name) })
          ),
